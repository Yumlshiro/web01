...
# Page configuration
st.set_page_config(page_title="Wongsakorn Tharathonbanpun", page_icon="🌘")

# Title
st.title("💀 Whoami")

# Introduction
st.subheader("I'm Wongsakorn Tharathonbanpun (Delta)")
st.write("""
...
st.write("""
- 📩 sansman933@gmail.com
- 🔗 [LinkedIn](https://www.linkedin.com/in/jeerasak-ananta-a1b4231a2/)
- 📖 [Medium](https://medium.com/@yumlshiro_1762/about)
""")
